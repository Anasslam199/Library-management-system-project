           ...
           <div class="row">
                 <div class="col-xs-12 col-md-6 col-lg-6 col-xl-4">
                     <div class="card-box noradius noborder bg-default">
                         <i class="fas fa-book-open float-right text-white"></i>
                         <h6 class="text-white text-uppercase m-b-20">{{__('messages.Books')}}</h6>
                         <h1 class="m-b-20 text-white counter">{{$Books}}</h1>
                         <span class="text-white">{{$Porcent}}% Borrowed</span>
                     </div>
                 </div>
                 ...
                 <div class="col-xs-12 col-md-6 col-lg-6 col-xl-4">
                     <div class="card-box noradius noborder bg-warning">
                         ...
                         <h6 class="text-white text-uppercase m-b-20">{{__('messages.Members')}}</h6>
                         <h1 class="m-b-20 text-white counter">{{$Members}}</h1>
                 ...
                 <div class="col-xs-12 col-md-6 col-lg-6 col-xl-4">
                     <div class="card-box noradius noborder bg-danger">
                         <i class="fas fa-book-reader float-right text-white"></i>
                         <h6 class="text-white text-uppercase m-b-20"> {{__('messages.Borrows')}}</h6>
                         <h1 class="m-b-20 text-white counter">{{$Borrows}}</h1>
                         <span class="text-white">  </span>
                     </div>
                 </div>
